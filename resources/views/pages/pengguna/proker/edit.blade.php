        ...
        <div class="card">
            <div class="card-body">
                ...
                <p class="text-muted mb-3">Isi form yang telah di sediakan, untuk uploud proposal LPJ bisa di kosongkan
                    terlebih dahulu</p>
                <form class="form-parsley" method="POST" action="{{route('update.proker', $proker->id)}}"
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control {{ $errors->has('nama_event') ? 'is-invalid' : '' }}"
                            name="nama_event" value="{{ old('nama_event', $proker->nama_event) }}" required>
                    ...
                    <div class="row">
                        <div class="form-group col-md-6">
                            ...
                            <select class="form-control" name="organisasi" value="{{ $proker->organisasi }}"
                                id="organisasi">
                        ...
                        <div class="form-group col-md-6" id="display-keterangan" style="display: none">
                            ...
                            <select class="form-control{{ $errors->has('nama_event') ? 'is-invalid' : '' }}"
                                name="keterangan" value="{{old('keterangan', $proker->keterangan) }}"
                    ...
                    {{-- <div class="form-group">
                        ...
                        <div class="col-sm-15">
                            <input class="form-control" type="text" name="tanggal_mulai"
                                value="{{ $proker->tanggal_mulai }}" id="datepicker1" readonly
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-15">
                            <input class="form-control" type="text" name="tanggal_selesai"
                                value="{{ $proker->tanggal_selesai }}" id="datepicker2" readonly
                                style="cursor: pointer; background: white">
                        </div>
                    </div> --}}
                    <div class="form-group">
                        ...
                        <div class="col-sm-15">
                            <select class="form-control" name="tempat">
                                <option value="Kampus" @if($proker->tempat === 'Kampus')
                                    selected
                                    @endif
                                    >Kampus</option>
                                <option value="Luar Kampus" @if($proker->tempat === 'Luar Kampus')
                                    selected
                                    @endif
                                    >Luar Kampus</option>
                            </select>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" value="{{old('alokasi_dana', $proker->alokasi_dana)  }}"
