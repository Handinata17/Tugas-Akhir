        ...
        <div class="card">
            <div class="card-body">
                ...
                <p class="text-muted mb-3">Isi form yang telah di sediakan, untuk uploud proposal LPJ bisa di kosongkan
                    terlebih dahulu</p>
                <form class="form-parsley" method="POST" action="{{route('update.recruitment', $recruitment->id)}}"
                    ...
                    <div class="form-group">
                        ...
                        <input type="text"
                            ...
                            name="nama_recruitment" value="{{ $recruitment->nama_recruitment }}" required>
                    ...
                    <div class="row">
                        <div class="form-group col-md-6">
                            ...
                            <select class="form-control" name="organisasi" 
                                    ...
                                    <option value="HIMA" {{ $recruitment->organisasi == "HIMA" ? 'selected' : '' }}>HIMA</option>
                                </select>
                        </div>
                        <div class="form-group col-md-6" id="display-keterangan" style="display: none">
                            <label>Keterangan</label>
                            <select class="form-control" name="keterangan" value="{{ $recruitment->keterangan }}"
                    ...
                    {{-- <div class="form-group">
                        ...
                        <div class="col-sm-15">
                            <input class="form-control" type="text" name="tanggal_mulai"
                                value="{{ $recruitment->tanggal_mulai}}" id="datepicker1" readonly
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-15">
                            <input class="form-control" type="text" name="tanggal_selesai"
                                value="{{ $recruitment->tanggal_selesai}}" id="datepicker2" readonly
                                style="cursor: pointer; background: white">
                        </div>
                    </div> --}}
