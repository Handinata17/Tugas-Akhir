                            ...
                            <div class="card-body">
                                ...
                                @csrf
                                    <div class="form-group">
                                        <label>No</label>
                                        <input type="text" class="form-control" name="no" placeholder="Type something">
                                    </div>
                                    <div class="form-group">
                                        <label>Nama</label>
                                    ...
                                    <div class="form-group">
                                        <label>Uraian</label>
                                        <input type="text" class="form-control" name="uraian" placeholder="Type something">
                                    </div>
                                    <div class="form-group">
                                        <label>Total Anggaran</label>
                                        <input type="text" class="form-control" name="total_anggaran" placeholder="Type something">
                                    </div>
