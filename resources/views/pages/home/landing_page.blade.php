...
<body>
    ...
    style="background-image: url({{ asset ('template/images/bg.jpg') }});
    background-position: center; background-size: cover; height: 700px">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <div class="page-title-box">
                                                    ...
                                                    <h4>
                                                        <p style="text-align:center">Pengurus Badan Perwakilan Mahasiswa
                                            ...
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    ...
                                                    <div class="card">
                                                        <div class="card-body">
                                                            ...
                                                            <p class="text-muted mb-3">Isi form yang telah di sediakan
                                                            </p>
                                                            <form class="form-parsley" method="POST"
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="number" id="nim"
                                                                        ...
                                                                        name="nim" type="text" value="{{old('nim')}}"
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <select name="id_recruitment"
                                                                        class="form-control recruitment"
                                                                        id="recruitment" required>
                                                                        <option value="">Pilih</option>
                                                                        @foreach($recruitments as $recruitment)
                                                                        <option value="{{ $recruitment->id }}">
                                                                            {{$recruitment->nama_recruitment}}
                                                                            {{$recruitment->keterangan}}</option>
                                                                        @endforeach
                                                                    </select>
                                                                    ...
                                                                    <div class="card" style="display :none"
                                                                        ...
                                                                        <div class="card-body">
                                                                            <div class="container">
                                                                                <div class="row">
                                                                                    <div class="col-sm-12">
                                                                                        <p id="organisasi">Organisasi :
                                                                                        </p>
                                                                                        <p id="keterangan">Keterangan :
                                                                                        </p>
                                                                                        <p id="tanggal_mulai">Tanggal
                                                                                            Mulai : </p>
                                                                                    </div>
                                                                                    <div class="col-sm">
                                                                                        <p id="tanggal_selesai">Tanggal
                                                                                            Selesai : </p>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input
                                                                            ...
                                                                            name="file" accept=".rar,.zip" type="file"
                                                                    ...
                                                                    <div class="form-group mb-0">
                                                                        <button type="submit"
                                                                            class="btn btn-gradient-primary waves-effect waves-light">Submit</button>
                                                                        <button type="reset" value="reset"
                                                                            class="btn btn-gradient-danger waves-effect m-l-5">Reset</button>
                                                                    </div>
                                                                    <!--end form-group-->
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="card">
                                                        <div class="card-body">
                                                            <p>Persyaratan Pendaftaran Pengurus BPM dan BEM Periode
                                                                2020/2021 :</p>
                                                                            ...
                                                                            <div class="row">
                                                                                ...
                                                                                <div class="row">
                                                                                    <div class="col-lg-6">@if(Session::has('failed'))
                                                                                        ...
                                                                                        <div class="alert alert-danger" role="alert">{{ dd($errors) }}
                                                            Pendaftaran Recruitment gagal! cek kembali</div>@endif
                                                        @if(Session::has('success'))
                                                        <div class="alert alert-success" role="alert">Pendaftaran
                                                            Recruitment berhasil</div>@endif
                                                        <div class="card">
                                                            <div class="card-body">
                                                                <h4 class="mt-0 header-title">Join Recruitment</h4>
                                                                <p class="text-muted mb-3">Isi form yang telah di
                                                                    sediakan</p>
                                                                <form class="form-parsley" method="POST"
                                                                    action="{{route('store.pendaftaran')}}"
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text" id="nim" class="form-control"
                                                                            name="nim" type="text" class="form-control"
                                                                            value="{{old('nim')}}"
                                                                            placeholder="Masukan Nim">
                                                                    </div>
                                                                    <div class="form-group">
    ...
    <script src="{{ asset ('landing_page/js/jquery-1.12.4.min.js') }}" type="d8c396bb02207cc85c9c2094-text/javascript">
    </script>
    <script src="{{ asset ('landing_page/js/popper.min.js') }}" type="d8c396bb02207cc85c9c2094-text/javascript">
    </script>
    <script src="{{ asset ('landing_page/js/bootstrap.min.js') }}" type="d8c396bb02207cc85c9c2094-text/javascript">
    </script>
    <script src="{{ asset ('landing_page/js/owl.carousel.min.js') }}" type="d8c396bb02207cc85c9c2094-text/javascript">
    </script>
    <script src="{{ asset ('landing_page/js/swiper.min.js') }}" type="d8c396bb02207cc85c9c2094-text/javascript">
    </script>
    <script src="{{ asset ('landing_page/js/jquery.counterup.min.js') }}"
        type="d8c396bb02207cc85c9c2094-text/javascript"></script>
    <script src="{{ asset ('landing_page/js/waypoints.min.js') }}" type="d8c396bb02207cc85c9c2094-text/javascript">
    </script>
    <script src="{{ asset ('landing_page/js/jquery.sticky.js') }}" type="d8c396bb02207cc85c9c2094-text/javascript">
    </script>
    <script src="{{ asset ('landing_page/js/scrolltotop.js') }}" type="d8c396bb02207cc85c9c2094-text/javascript">
    </script>
    <script src="{{ asset ('landing_page/js/contact-form-script.js') }}"
        type="d8c396bb02207cc85c9c2094-text/javascript"></script>
    <script src="{{ asset ('landing_page/js/jquery.ajaxchimp.js') }}" type="d8c396bb02207cc85c9c2094-text/javascript">
    </script>
    ...
    <script src="{{ asset ('landing_page/js/smooth-scroll.min.js') }}" type="d8c396bb02207cc85c9c2094-text/javascript">
    </script>
    <script src="{{ asset ('landing_page/js/slicknav-min.js') }}" type="d8c396bb02207cc85c9c2094-text/javascript">
    </script>
    <script src="{{ asset ('landing_page/js/jquery.barChart.js') }}" type="d8c396bb02207cc85c9c2094-text/javascript">
    </script>
    <script src="{{ asset ('landing_page/js/jquery.barfiller.js') }}" type="d8c396bb02207cc85c9c2094-text/javascript">
    </script>
    <script src="{{ asset ('landing_page/js/jquery.lineProgressbar.js') }}"
        type="d8c396bb02207cc85c9c2094-text/javascript"></script>
    <script src="{{ asset ('landing_page/js/main.js') }}" type="d8c396bb02207cc85c9c2094-text/javascript"></script>
    <script src="https://ajax.cloudflare.com/cdn-cgi/scripts/7089c43e/cloudflare-static/rocket-loader.min.js') }}"
        data-cf-settings="d8c396bb02207cc85c9c2094-|49" defer=""></script>
    <script>
