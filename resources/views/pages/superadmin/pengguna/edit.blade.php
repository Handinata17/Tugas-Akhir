                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form class="form-parsley" method="POST" action="{{route('update.pengguna', $pengguna->id)}}" enctype="multipart/form-data">
                                    @method('PUT')
                                @csrf
                                    ...
                                    <div class="form-group mb-2 ml-3">
                                        ...
                                        <a class="btn btn-gradient-danger btn-close waves-effect m-l-5" href="{{ route('pengguna') }}">Cancel</a>
                                    </div>
                                    <!--end form-group-->
                                </form>
                                <!--end form-->
