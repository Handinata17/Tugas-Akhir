<div class="topbar">
        ...
        <nav class="navbar-custom">
            <ul class="list-unstyled topbar-nav float-right mb-0">
                <!-- <li class="hidden-sm"><a class="nav-link dropdown-toggle waves-effect waves-light" data-toggle="dropdown" href="javascript: void(0);" role="button" aria-haspopup="false" aria-expanded="false">English <img src="{{asset('template/images/flags/us_flag.jpg')}}" class="ml-2" height="16" alt=""> <i class="mdi mdi-chevron-down"></i></a> -->
                    <!-- <div class="dropdown-menu dropdown-menu-right"><a class="dropdown-item" href="javascript: void(0);"><span>German </span><img src="{{asset('template/images/flags/germany_flag.jpg')}}" alt="" class="ml-2 float-right" height="14"></a><a class="dropdown-item" href="javascript: void(0);"><span>Italian </span><img src="{{asset('template/images/flags/italy_flag.jpg')}}" alt="" class="ml-2 float-right" height="14"></a><a class="dropdown-item" href="javascript: void(0);"><span>French </span><img src="{{asset('template/images/flags/french_flag.jpg')}}" alt="" class="ml-2 float-right" height="14"></a><a class="dropdown-item" href="javascript: void(0);"><span>Spanish </span><img src="{{asset('template/images/flags/spain_flag.jpg')}}" alt="" class="ml-2 float-right" height="14"></a><a class="dropdown-item" href="javascript: void(0);"><span>Russian </span><img src="{{asset('template/images/flags/russia_flag.jpg')}}" alt="" class="ml-2 float-right" height="14"></a></div> -->
                </li>
                ...
                <li class="dropdown">
                    ...
                    <a class="nav-link dropdown-toggle waves-effect waves-light nav-user" data-toggle="dropdown" href="{{ route ('profil.index')}}" role="button" aria-haspopup="false" aria-expanded="false"><img src="{{asset('template/images/users/user.png')}}" alt="profile-user" class="rounded-circle">
                     <span class="ml-1 nav-user-name hidden-sm">{{Auth::user()->name}}<i class="mdi mdi-chevron-down"></i></span></a>
                    <div class="dropdown-menu dropdown-menu-right">
                        <a class="dropdown-item" href="#"><i class="dripicons-user text-muted mr-2"></i> Profile</a> <a class="dropdown-item" href="#"><i class="dripicons-gear text-muted mr-2"></i> Settings</a>
                    ...
                    <div class="dropdown-menu dropdown-menu-right"><a class="dropdown-item" href="{{ route ('profil.index')}}"><i class="dripicons-user text-muted mr-2"></i> Profile</a> <a class="dropdown-item" href="#"><i class="dripicons-gear text-muted mr-2"></i> Settings</a>
            ...
            <!-- <ul class="list-unstyled topbar-nav mb-0"> -->
                <!-- <li><span class="responsive-logo"><img src="{{asset('template/images/logo-sm.png')}}" alt="logo-small" class="logo-sm align-self-center" height="34"></span></li> -->
                <!-- <li> -->
                        ...
                        <div class="row no-gutters">
                            <div class="col-12 col-lg-6">
                                <div class="text-center system-text">
                                    ...
                                    <p class="text-white">See all the pages Metrica.</p><a href="https://mannatthemes.com/metrica/" class="btn btn-sm btn-pink mt-2">See Dashboard</a></div>
                                <div id="carouselExampleFade" class="carousel slide carousel-fade" data-ride="carousel">
                                    <div class="carousel-inner">
                                        <div class="carousel-item active"><img src="{{asset('template/images/dashboard/dash-1.png')}}" class="d-block img-fluid" alt="..."></div>
                                        <div class="carousel-item"><img src="{{asset('template/images/dashboard/dash-4.png')}}" class="d-block img-fluid" alt="..."></div>
                                        <div class="carousel-item"><img src="{{asset('template/images/dashboard/dash-2.png')}}" class="d-block img-fluid" alt="..."></div>
                                        <div class="carousel-item"><img src="{{asset('template/images/dashboard/dash-3.png')}}" class="d-block img-fluid" alt="..."></div>
                                    </div>
                                </div>
                            </div>
                            <!--end col-->
                            <div class="col-12 col-lg-6">
                                <div class="divider-custom mb-0">
                                    ...
                                    <div class="p-4">
                                        <div class="row">
                                            <div class="col-6"><a class="dropdown-item mb-2" href="../vertical-2/analytics-index.html">Analytics</a> <a class="dropdown-item mb-2" href="../vertical-2/crypto-index.html">Crypto</a> <a class="dropdown-item mb-2" href="../vertical-2/crm-index.html">CRM</a> <a class="dropdown-item" href="../vertical-2/projects-index.html">Project</a></div>
                                            <div class="col-6"><a class="dropdown-item mb-2" href="../vertical-2/ecommerce-index.html">Ecommerce</a> <a class="dropdown-item mb-2" href="../vertical-2/helpdesk-index.html">Helpdesk</a> <a class="dropdown-item" href="../vertical-2/hospital-index.html">Hospital</a></div>
                                        </div>
                                    </div>
                                </div>
                                <!--end col-->
