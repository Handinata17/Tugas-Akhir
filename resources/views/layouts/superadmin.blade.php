    ...
    <div class="topbar">
        ...
        <nav class="navbar-custom">
            <ul class="list-unstyled topbar-nav float-right mb-0">
                <li class="hidden-sm"><a class="nav-link dropdown-toggle waves-effect waves-light" data-toggle="dropdown" href="javascript: void(0);" role="button" aria-haspopup="false" aria-expanded="false">English <img src="../assets/images/flags/us_flag.jpg" class="ml-2" height="16" alt=""> <i class="mdi mdi-chevron-down"></i></a>
            ...
            <div class="main-menu-inner">
                <div class="menu-body slimscroll">
                    <div id="MetricaAnalytic" class="main-icon-menu-pane">
                        ...
                        <ul class="nav">
                            <li class="nav-item"><a class="nav-link" href="https://mannatthemes.com/metrica/light/analytics/analytics-index.html"><i class="dripicons-meter"></i>Dashboard</a></li>
                            <li class="nav-item"><a class="nav-link" href="https://mannatthemes.com/metrica/light/analytics/analytics-customers.html"><i class="dripicons-user-group"></i>Customers</a></li>
                            <li class="nav-item"><a class="nav-link" href="https://mannatthemes.com/metrica/light/analytics/analytics-reports.html"><i class="dripicons-document"></i>Reports</a></li>
                        </ul>
                    </div>
                    <!-- end Analytic -->
                    <div id="MetricaCrypto" class="main-icon-menu-pane">
                        ...
                        <ul class="nav">
                            <li class="nav-item"><a class="nav-link" href="https://mannatthemes.com/metrica/light/crypto/crypto-index.html"><i class="dripicons-device-desktop"></i>Dashboard</a></li>
                            <li class="nav-item"><a class="nav-link" href="https://mannatthemes.com/metrica/light/crypto/crypto-exchange.html"><i class="dripicons-swap"></i>Exchange</a></li>
                            <li class="nav-item"><a class="nav-link" href="https://mannatthemes.com/metrica/light/crypto/crypto-wallet.html"><i class="dripicons-wallet"></i>My Wallet</a></li>
                            <li class="nav-item"><a class="nav-link" href="https://mannatthemes.com/metrica/light/crypto/crypto-calendar.html"><i class="dripicons-calendar"></i>Calendar</a></li>
                            <li class="nav-item"><a class="nav-link" href="https://mannatthemes.com/metrica/light/crypto/crypto-news.html"><i class="dripicons-blog"></i>Crypto News</a></li>
                            <li class="nav-item"><a class="nav-link" href="https://mannatthemes.com/metrica/light/crypto/crypto-ico.html"><i class="dripicons-stack"></i>ICO List</a></li>
                            <li class="nav-item"><a class="nav-link" href="https://mannatthemes.com/metrica/light/crypto/crypto-settings.html"><i class="dripicons-gear"></i>Settings</a></li>
                        </ul>
                    </div>
                    <!-- end Crypto -->
                    <div id="MetricaProject" class="main-icon-menu-pane">
                        <div class="title-box">
                            <h6 class="menu-title">Projects</h6></div>
                        <ul class="nav">
                            <li class="nav-item"><a class="nav-link" href="projects-index.html"><i class="dripicons-view-thumb"></i>Dashboard</a></li>
                            <li class="nav-item"><a class="nav-link" href="projects-clients.html"><i class="dripicons-user-id"></i>Clients</a></li>
                            <li class="nav-item"><a class="nav-link" href="projects-calendar.html"><i class="dripicons-calendar"></i>Calendar</a></li>
                            <li class="nav-item"><a class="nav-link" href="projects-team.html"><i class="dripicons-trophy"></i>Team</a></li>
                            <li class="nav-item"><a class="nav-link" href="projects-project.html"><i class="dripicons-jewel"></i>Project</a></li>
                            <li class="nav-item"><a class="nav-link" href="projects-task.html"><i class="dripicons-checklist"></i>Task</a></li>
                            <li class="nav-item"><a class="nav-link" href="projects-kanban-board.html"><i class="dripicons-move"></i>Kanban Board</a></li>
                            <li class="nav-item"><a class="nav-link" href="projects-invoice.html"><i class="dripicons-document"></i>Invoice</a></li>
                            <li class="nav-item"><a class="nav-link" href="projects-chat.html"><i class="dripicons-conversation"></i>Chat</a></li>
                            <li class="nav-item"><a class="nav-link" href="projects-users.html"><i class="dripicons-user-group"></i>Users</a></li>
                        </ul>
                    </div>
                    <!-- end  Project-->
                    <div id="MetricaEcommerce" class="main-icon-menu-pane">
                        ...
                        <ul class="nav">
                            <li class="nav-item"><a class="nav-link" href="https://mannatthemes.com/metrica/light/ecommerce/ecommerce-index.html"><i class="dripicons-device-desktop"></i>Dashboard</a></li>
                            <li class="nav-item"><a class="nav-link" href="https://mannatthemes.com/metrica/light/ecommerce/ecommerce-products.html"><i class="dripicons-view-apps"></i>Products</a></li>
                            <li class="nav-item"><a class="nav-link" href="https://mannatthemes.com/metrica/light/ecommerce/ecommerce-product-list.html"><i class="dripicons-list"></i>Product List</a></li>
                            <li class="nav-item"><a class="nav-link" href="https://mannatthemes.com/metrica/light/ecommerce/ecommerce-product-detail.html"><i class="dripicons-article"></i>Product Detail</a></li>
                            <li class="nav-item"><a class="nav-link" href="https://mannatthemes.com/metrica/light/ecommerce/ecommerce-cart.html"><i class="dripicons-cart"></i>Cart</a></li>
                            <li class="nav-item"><a class="nav-link" href="https://mannatthemes.com/metrica/light/ecommerce/ecommerce-checkout.html"><i class="dripicons-card"></i>Checkout</a></li>
                        </ul>
                    </div>
                    <!-- end Ecommerce -->
                    <div id="MetricaCRM" class="main-icon-menu-pane">
                        <div class="title-box">
                            <h6 class="menu-title">CRM</h6></div>
                        <ul class="nav">
                            <li class="nav-item"><a class="nav-link" href="https://mannatthemes.com/metrica/light/crm/crm-index.html"><i class="dripicons-monitor"></i>Dashboard</a></li>
                            <li class="nav-item"><a class="nav-link" href="https://mannatthemes.com/metrica/light/crm/crm-contacts.html"><i class="dripicons-user-id"></i>Contacts</a></li>
                            <li class="nav-item"><a class="nav-link" href="https://mannatthemes.com/metrica/light/crm/crm-opportunities.html"><i class="dripicons-lightbulb"></i>Opportunities</a></li>
                            <li class="nav-item"><a class="nav-link" href="https://mannatthemes.com/metrica/light/crm/crm-leads.html"><i class="dripicons-toggles"></i>Leads</a></li>
                            <li class="nav-item"><a class="nav-link" href="https://mannatthemes.com/metrica/light/crm/crm-customers.html"><i class="dripicons-user-group"></i>Customers</a></li>
                        </ul>
                    </div>
                    <!-- end CRM -->
                    <div id="MetricaOthers" class="main-icon-menu-pane">
                        <div class="title-box">
                            <h6 class="menu-title">Others</h6></div>
                        <ul class="nav metismenu" id="main_menu_side_nav">
                            <li class="nav-item"><a class="nav-link" href="#"><i class="dripicons-mail"></i><span class="w-100">Email</span><span class="menu-arrow"><i class="mdi mdi-chevron-right"></i></span></a>
                                <ul class="nav-second-level" aria-expanded="false">
                                    <li><a href="https://mannatthemes.com/metrica/light/others/email-inbox.html">Inbox</a></li>
                                    <li><a href="https://mannatthemes.com/metrica/light/others/email-read.html">Read Email</a></li>
                                </ul>
                            </li>
                            <!--end nav-item-->
                            <li class="nav-item"><a class="nav-link" href="#"><i class="dripicons-view-thumb"></i><span class="w-100">UI Elements</span><span class="menu-arrow"><i class="mdi mdi-chevron-right"></i></span></a>
                                <ul class="nav-second-level" aria-expanded="false">
                                    <li><a href="https://mannatthemes.com/metrica/light/others/ui-bootstrap.html">Bootstrap</a></li>
                                    <li><a href="https://mannatthemes.com/metrica/light/others/ui-animation.html">Animation</a></li>
                                    <li><a href="https://mannatthemes.com/metrica/light/others/ui-avatar.html">Avatar</a></li>
                                    <li><a href="https://mannatthemes.com/metrica/light/others/ui-clipboard.html">Clip Board</a></li>
                                    <li><a href="https://mannatthemes.com/metrica/light/others/ui-files.html">File Manager</a></li>
                                    <li><a href="https://mannatthemes.com/metrica/light/others/ui-ribbons.html">Ribbons</a></li>
                                    <li><a href="https://mannatthemes.com/metrica/light/others/ui-dragula.html"><span>Dragula</span></a></li>
                                    <li><a href="https://mannatthemes.com/metrica/light/others/ui-check-radio.html"><span>Check & Radio</span></a></li>
                                </ul>
                            </li>
                            <!--end nav-item-->
                            <li class="nav-item"><a class="nav-link" href="#"><i class="dripicons-anchor"></i><span class="w-100">Advanced UI</span><span class="menu-arrow"><i class="mdi mdi-chevron-right"></i></span></a>
                                <ul class="nav-second-level" aria-expanded="false">
                                    <li><a href="https://mannatthemes.com/metrica/light/others/advanced-rangeslider.html">Range Slider</a></li>
                                    <li><a href="https://mannatthemes.com/metrica/light/others/advanced-sweetalerts.html">Sweet Alerts</a></li>
                                    <li><a href="https://mannatthemes.com/metrica/light/others/advanced-nestable.html">Nestable List</a></li>
                                    <li><a href="https://mannatthemes.com/metrica/light/others/advanced-ratings.html">Ratings</a></li>
                                    <li><a href="https://mannatthemes.com/metrica/light/others/advanced-highlight.html">Highlight</a></li>
                                    <li><a href="https://mannatthemes.com/metrica/light/others/advanced-session.html">Session Timeout</a></li>
                                    <li><a href="https://mannatthemes.com/metrica/light/others/advanced-idle-timer.html">Idle Timer</a></li>
                                </ul>
                            </li>
                            <!--end nav-item-->
                            <li class="nav-item"><a class="nav-link" href="#"><i class="dripicons-document"></i><span class="w-100">Forms</span><span class="menu-arrow"><i class="mdi mdi-chevron-right"></i></span></a>
                                <ul class="nav-second-level" aria-expanded="false">
                                    <li><a href="https://mannatthemes.com/metrica/light/others/forms-elements.html">Basic Elements</a></li>
                                    <li><a href="https://mannatthemes.com/metrica/light/others/forms-advanced.html">Advance Elements</a></li>
                                    <li><a href="https://mannatthemes.com/metrica/light/others/forms-validation.html">Validation</a></li>
                                    <li><a href="https://mannatthemes.com/metrica/light/others/forms-wizard.html">Wizard</a></li>
                                    <li><a href="https://mannatthemes.com/metrica/light/others/forms-editors.html">Editors</a></li>
                                    <li><a href="https://mannatthemes.com/metrica/light/others/forms-repeater.html">Repeater</a></li>
                                    <li><a href="https://mannatthemes.com/metrica/light/others/forms-x-editable.html">X Editable</a></li>
                                    <li><a href="https://mannatthemes.com/metrica/light/others/forms-uploads.html">File Upload</a></li>
                                    <li><a href="https://mannatthemes.com/metrica/light/others/forms-img-crop.html">Image Crop</a></li>
                                </ul>
                            </li>
                            <!--end nav-item-->
                            <li class="nav-item"><a class="nav-link" href="#"><i class="dripicons-graph-line"></i><span class="w-100">Charts</span><span class="menu-arrow"><i class="mdi mdi-chevron-right"></i></span></a>
                                <ul class="nav-second-level" aria-expanded="false">
                                    <li><a href="https://mannatthemes.com/metrica/light/others/charts-apex.html">Apex</a></li>
                                    <li><a href="https://mannatthemes.com/metrica/light/others/charts-morris.html">Morris</a></li>
                                    <li><a href="https://mannatthemes.com/metrica/light/others/charts-chartist.html">Chartist</a></li>
                                    <li><a href="https://mannatthemes.com/metrica/light/others/charts-flot.html">Flot</a></li>
                                    <li><a href="https://mannatthemes.com/metrica/light/others/charts-peity.html">Peity</a></li>
                                    <li><a href="https://mannatthemes.com/metrica/light/others/charts-chartjs.html">Chartjs</a></li>
                                    <li><a href="https://mannatthemes.com/metrica/light/others/charts-sparkline.html">Sparkline</a></li>
                                    <li><a href="https://mannatthemes.com/metrica/light/others/charts-knob.html">Jquery Knob</a></li>
                                    <li><a href="https://mannatthemes.com/metrica/light/others/charts-justgage.html">JustGage</a></li>
                                </ul>
                            </li>
                            <!--end nav-item-->
                            <li class="nav-item"><a class="nav-link" href="#"><i class="dripicons-view-list-large"></i><span class="w-100">Tables</span><span class="menu-arrow"><i class="mdi mdi-chevron-right"></i></span></a>
                                <ul class="nav-second-level" aria-expanded="false">
                                    <li><a href="https://mannatthemes.com/metrica/light/others/tables-basic.html">Basic</a></li>
                                    <li><a href="https://mannatthemes.com/metrica/light/others/tables-datatable.html">Datatables</a></li>
                                    <li><a href="https://mannatthemes.com/metrica/light/others/tables-responsive.html">Responsive</a></li>
                                    <li><a href="https://mannatthemes.com/metrica/light/others/tables-footable.html">Footable</a></li>
                                    <li><a href="https://mannatthemes.com/metrica/light/others/tables-jsgrid.html">Jsgrid</a></li>
                                    <li><a href="https://mannatthemes.com/metrica/light/others/tables-editable.html">Editable</a></li>
                                </ul>
                            </li>
                            <!--end nav-item-->
                            <li class="nav-item"><a class="nav-link" href="#"><i class="dripicons-headset"></i><span class="w-100">Icons</span><span class="menu-arrow"><i class="mdi mdi-chevron-right"></i></span></a>
                                <ul class="nav-second-level" aria-expanded="false">
                                    <li><a href="https://mannatthemes.com/metrica/light/others/icons-materialdesign.html">Material Design</a></li>
                                    <li><a href="https://mannatthemes.com/metrica/light/others/icons-dripicons.html">Dripicons</a></li>
                                    <li><a href="https://mannatthemes.com/metrica/light/others/icons-fontawesome.html">Font awesome</a></li>
                                    <li><a href="https://mannatthemes.com/metrica/light/others/icons-themify.html">Themify</a></li>
                                    <li><a href="https://mannatthemes.com/metrica/light/others/icons-typicons.html">Typicons</a></li>
                                    <li><a href="https://mannatthemes.com/metrica/light/others/icons-emoji.html">Emoji <i class="em em-ok_hand"></i></a></li>
                                    <li><a href="https://mannatthemes.com/metrica/light/others/icons-svg.html">SVG</a></li>
                                </ul>
                            </li>
                            <!--end nav-item-->
                            <li class="nav-item"><a class="nav-link" href="#"><i class="dripicons-map"></i><span class="w-100">Maps</span><span class="menu-arrow"><i class="mdi mdi-chevron-right"></i></span></a>
                                <ul class="nav-second-level" aria-expanded="false">
                                    <li><a href="https://mannatthemes.com/metrica/light/others/maps-google.html">Google Maps</a></li>
                                    <li><a href="https://mannatthemes.com/metrica/light/others/maps-vector.html">Vector Maps</a></li>
                                </ul>
                            </li>
                            <!--end nav-item-->
                            <li class="nav-item"><a class="nav-link" href="#"><i class="dripicons-article"></i><span class="w-100">Email Templates</span><span class="menu-arrow"><i class="mdi mdi-chevron-right"></i></span></a>
                                <ul class="nav-second-level" aria-expanded="false">
                                    <li><a href="https://mannatthemes.com/metrica/light/others/email-templates-basic.html">Basic Action Email</a></li>
                                    <li><a href="https://mannatthemes.com/metrica/light/others/email-templates-alert.html">Alert Email</a></li>
                                    <li><a href="https://mannatthemes.com/metrica/light/others/email-templates-billing.html">Billing Email</a></li>
                                </ul>
                            </li>
                            <!--end nav-item-->
                        </ul>
                    ...
                    <div id="MetricaPages" class="main-icon-menu-pane">
                        <div class="title-box">
                            <h6 class="menu-title">Pages</h6></div>
                        <ul class="nav">
                            <li class="nav-item"><a class="nav-link" href="https://mannatthemes.com/metrica/light/pages/pages-profile.html"><i class="dripicons-user"></i>Profile</a></li>
                            <li class="nav-item"><a class="nav-link" href="https://mannatthemes.com/metrica/light/pages/pages-chat.html"><i class="dripicons-conversation"></i>Chat</a></li>
                            <li class="nav-item"><a class="nav-link" href="https://mannatthemes.com/metrica/light/pages/pages-contact-list.html"><i class="dripicons-user-id"></i>Contact List</a></li>
                            <li class="nav-item"><a class="nav-link" href="https://mannatthemes.com/metrica/light/pages/pages-tour.html"><i class="dripicons-rocket"></i>Tour</a></li>
                            <li class="nav-item"><a class="nav-link" href="https://mannatthemes.com/metrica/light/pages/pages-timeline.html"><i class="dripicons-clock"></i>Timeline</a></li>
                            <li class="nav-item"><a class="nav-link" href="https://mannatthemes.com/metrica/light/pages/pages-invoice.html"><i class="dripicons-document"></i>Invoice</a></li>
                            <li class="nav-item"><a class="nav-link" href="https://mannatthemes.com/metrica/light/pages/pages-treeview.html"><i class="dripicons-network-3"></i>Treeview</a></li>
                            <li class="nav-item"><a class="nav-link" href="https://mannatthemes.com/metrica/light/pages/pages-starter.html"><i class="dripicons-clipboard"></i>Starter Page</a></li>
                            <li class="nav-item"><a class="nav-link" href="https://mannatthemes.com/metrica/light/pages/pages-pricing.html"><i class="dripicons-article"></i>Pricing</a></li>
                            <li class="nav-item"><a class="nav-link" href="https://mannatthemes.com/metrica/light/pages/pages-blogs.html"><i class="dripicons-blog"></i>Blogs</a></li>
                            <li class="nav-item"><a class="nav-link" href="https://mannatthemes.com/metrica/light/pages/pages-faq.html"><i class="dripicons-question"></i>FAQs</a></li>
                            <li class="nav-item"><a class="nav-link" href="https://mannatthemes.com/metrica/light/pages/pages-gallery.html"><i class="dripicons-photo-group"></i>Gallery</a></li>
                        </ul>
                    </div>
                    <!-- end Pages -->
                    <div id="MetricaAuthentication" class="main-icon-menu-pane">
                        <div class="title-box">
                            <h6 class="menu-title">Authentication</h6></div>
                        <ul class="nav">
                            <li class="nav-item"><a class="nav-link" href="https://mannatthemes.com/metrica/light/authentication/auth-login.html"><i class="dripicons-enter"></i>Log in</a></li>
                            <li class="nav-item"><a class="nav-link" href="https://mannatthemes.com/metrica/light/authentication/auth-register.html"><i class="dripicons-pencil"></i>Register</a></li>
                            <li class="nav-item"><a class="nav-link" href="https://mannatthemes.com/metrica/light/authentication/auth-recover-pw.html"><i class="dripicons-clockwise"></i>Recover Password</a></li>
                            <li class="nav-item"><a class="nav-link" href="https://mannatthemes.com/metrica/light/authentication/auth-lock-screen.html"><i class="dripicons-lock"></i>Lock Screen</a></li>
                            <li class="nav-item"><a class="nav-link" href="https://mannatthemes.com/metrica/light/authentication/auth-404.html"><i class="dripicons-warning"></i>Error 404</a></li>
                            <li class="nav-item"><a class="nav-link" href="https://mannatthemes.com/metrica/light/authentication/auth-500.html"><i class="dripicons-wrong"></i>Error 500</a></li>
                        </ul>
                    </div>
                    <!-- end Authentication-->
                </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-8 col-8 align-self-center text-right">
                                                <div class="ml-2">
                                                    ...
                                                    <h4 class="mt-0 mb-1">$18090</h4></div>
                                            </div>
                                        </div>
                                        <div class="progress mt-2" style="height:3px;">
                                            ...
                                            <div class="row">
                                                <div class="col-12 align-self-center">
                                                    <div class="text-center">
                                                        ...
                                                        <div class="my-3"><img src="https://mannatthemes.com/metrica/light/assets/images/widgets/p-1.svg" alt="" height="103" class=""></div>
                                        ...
                                        <div class="carousel-item">
                                            <div class="row">
                                                <div class="col-12 align-self-center">
                                                    <div class="text-center">
                                                        <h4 class="mt-0 header-title text-left">Project Launch Date</h4>
                                                        <div class="my-3"><img src="https://mannatthemes.com/metrica/light/assets/images/widgets/p-2.svg" alt="" height="103" class=""></div>
                                        ...
                                        <div class="carousel-item">
                                            <div class="row">
                                                <div class="col-12 align-self-center">
                                                    <div class="text-center">
                                                        <h4 class="mt-0 header-title text-left">Project Launch Date</h4>
                                                        <div class="my-3"><img src="https://mannatthemes.com/metrica/light/assets/images/widgets/p-3.svg" alt="" height="103" class=""></div>
                                        ...
                                        <div class="carousel-item">
                                            <div class="row">
                                                <div class="col-12 align-self-center">
                                                    <div class="text-center">
                                                        <h4 class="mt-0 header-title text-left">Project Launch Date</h4>
                                                        <div class="my-3"><img src="https://mannatthemes.com/metrica/light/assets/images/widgets/p-4.svg" alt="" height="103" class=""></div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="slimscroll project-dash-activity">
                                    <div class="activity"><i class="mdi mdi-check text-success"></i>
                                        <div class="time-item">
                                            <div class="item-info">
                                        ...
                                        </div><i class="mdi mdi-alert-outline text-warning"></i>
                                        <div class="time-item">
                                            <div class="item-info">
                                        ...
                                        </div><i class="mdi mdi-code-tags-check text-info"></i>
                                        <div class="time-item">
                                            <div class="item-info">
                                        ...
                                        </div><i class="mdi mdi-comment-outline text-purple"></i>
                                        <div class="time-item">
                                            <div class="item-info">
                                        ...
                                        </div><i class="mdi mdi-clock-start text-secondary"></i>
                                        <div class="time-item">
                                            <div class="item-info">
                                                <div class="text-muted text-right font-10">5 minutes ago</div>
                                        ...
                                        </div><i class="mdi mdi-check text-success"></i>
                                        <div class="time-item">
                                            <div class="item-info">
                                                <div class="text-muted text-right font-10">5 minutes ago</div>
                                                <h5 class="mt-0">Task finished</h5>
...
<!-- Mirrored from mannatthemes.com/metrica/light/projects/projects-index.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 27 Feb 2020 14:16:33 GMT -->
